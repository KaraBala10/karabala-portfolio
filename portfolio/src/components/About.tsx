          ...
          <div className="flex-1 order-2 lg:order-1 text-center lg:text-left space-y-8">
              ...
              {[
                {
                  icon: "✉️",
                  label: "Email",
                  value: "mohammad.karabala@gmail.com",
                },
                ...
                <div
                  key={idx}
                  className="flex items-center space-x-4 p-4 rounded-xl border border-formal-200 dark:border-formal-700 bg-white/50 dark:bg-formal-800/50 backdrop-blur-sm transition-colors hover:border-formal-300 dark:hover:border-formal-600"
                >
                  <span className="text-2xl">{item.icon}</span>
                  <div className="text-left">
                    <div className="text-xs uppercase tracking-wider text-formal-500 dark:text-formal-400 font-semibold">
                      {item.label}
                    </div>
                    <div className="text-sm font-medium text-formal-900 dark:text-formal-100">
                      {item.value}
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-6">
              <a
                ...
                download
                className="inline-flex items-center space-x-2 px-6 py-3 bg-formal-900 dark:bg-formal-50 hover:bg-formal-800 dark:hover:bg-formal-200 text-white dark:text-formal-900 rounded-lg font-medium transition-colors shadow-md shadow-formal-900/10 dark:shadow-formal-50/5"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <a
                href="#contact"
                className="inline-flex items-center space-x-2 px-6 py-3 bg-white dark:bg-formal-900 hover:bg-formal-50 dark:hover:bg-formal-800 text-formal-900 dark:text-formal-50 border border-formal-200 dark:border-formal-700 rounded-lg font-medium transition-colors shadow-sm"
              >
          ...
          <div className="flex-1 order-1 lg:order-2 w-full max-w-md lg:max-w-none mx-auto relative">
            <div className="relative z-10 p-2 rounded-2xl bg-white dark:bg-formal-800 shadow-xl shadow-formal-900/5 dark:shadow-black/20 ring-1 ring-formal-900/5 dark:ring-formal-50/5 aspect-[4/5] sm:aspect-auto overflow-hidden">
              ...
              <div className="absolute top-6 right-6 inline-flex items-center space-x-2 bg-white/90 dark:bg-formal-900/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg ring-1 ring-black/5 dark:ring-white/10">
                ...
                <span className="text-xs font-semibold uppercase tracking-wider text-formal-900 dark:text-formal-100">
                  Available for work
                </span>
              </div>
            </div>
